...
<body id="page-top">
        ...
        <div class="container px-4 px-lg-5 h-100">
            <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                <div class="col-lg-8 align-self-end">
                    <h1 class="text-white font-weight-bold">Welkom bij Exploro!</h1>
                    <hr class="divider" />
                </div>
        ...
        <div class="container px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-lg-8 text-center">
                    <h2 class="text-white mt-0">Het leerdoel</h2>
                    <hr class="divider divider-light" />
                    <p class="text-white-75 mb-4">Wij hebben gekozen voor het leerdoel waarbij studenten het toeristische en recreatieve aanbod van plaatsen en regio's vanuit natuurlijke, culturele of sociaaleconomische factoren beschijven!</p>
    ...
    <section class="page-section" id="services">
        <div class="container px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-lg-8 text-center">
                    <h2 class="text-black mt-0">Registreer hier!</h2>
                    <hr class="divider divider-light" />
                    <p class="text-black-75 mb-4">Registreer nu om een account aan te maken om aan de hand van dit account in te loggen op de app om de game te kunnen spelen en meer bij te leren!</p>
                    <a class="btn btn-primary btn-xl" href="signup.html">Registreer</a>
                </div>
            </div>
        </div>
    </section>
